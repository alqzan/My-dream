...
export function PendingBankBanner() {
  ...
  return (
    <button
      onClick={openReview}
    className="mdr-pending-banner w-full flex items-center gap-3 bg-finance/10 border border-finance/20 rounded-2xl px-4 py-3 text-right press animate-fade-up"
    >

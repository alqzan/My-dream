...
export const PLAN_SECTIONS = ["daily", "budgets", "shelf", "recurring", "installments", "assets", "reserves"] as const;
...
export function defaultPlanOpen(attention: {
  ...
  const base: Record<PlanSectionId, boolean> = {
    daily: false, budgets: false, shelf: false, recurring: false, installments: false, assets: false, reserves: false,
  };

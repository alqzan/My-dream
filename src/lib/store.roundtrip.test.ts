...
const FULL: Required<AppData> = {
  ...
  reserves: [{
    ...
    // رحلتان: منتهيةٌ وجارية — المجموعةُ الداخلية الثانية على المظروف بعد
    // الإيداعات، ولها دمجُها المستقلّ. سقوطُها في الدورة يمحو سجلَّ السفر.
    trips: [
      { id: "tr-1", startedAt: "2026-03-10", endedAt: "2026-03-14" },
      { id: "tr-2", startedAt: "2026-06-01" },
    ],
  }],

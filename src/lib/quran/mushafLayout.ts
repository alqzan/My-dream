...
//
// المقاس أصليّ لا مطلق: قِيس على عرض سطرٍ 270px بخطّ **مجمّع الملك فهد (حفص)**
// حجم 16px. وكلّ عرضٍ آخر تكبيرٌ متناسب (`pageFontSize`) — النسب محفوظة فالأسطر
// تبقى منطبقة. والخطُّ والبيانات صنوان لا يُبدَّل أحدهما وحده.
//
 ...
 * العرض ولا يصيبه تماماً — مسحُ الأسطر الثمانية آلاف والسبعمئة كلّها في المتصفّح
 * بخطّ «حفص» وقع بين 97.3% و101.0% من عرض السطر (والوسيط 99.4%). فما زاد يسيرٌ
 * لا يُقصّ: حشوُ الورقة حول الوجه يبتلعه، وهو أوسع من أعرض فيضٍ فيها.
 */

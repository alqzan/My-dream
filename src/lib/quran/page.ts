...
// الأصليّ كما هو.
//
// **حدّ المعرفة، وقد قُصِد**: بيانات المستودع تعرف أوّل آيةٍ في كلّ صفحة
// (PAGE_STARTS) ولا تعرف توزيع الأسطر داخلها. فالموضع الرأسيّ هنا **نسبةٌ من
// آيات الصفحة** لا رقمُ سطرٍ في مصحف المدينة — تقريبٌ صادق يخدم التذكّر، ولا
// يُقدَّم للمالك على أنه رقم سطر. أمّا «يُمنى/يُسرى» فمعلومةٌ قاطعة لا تقريب
// فيها (تُشتقّ من رقم الصفحة).

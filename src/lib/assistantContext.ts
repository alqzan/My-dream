...
// مذكرات خام) بقيّةً من مساعدٍ قديم لم يعُد يُستدعى — أُزيل، ثمّ أُزيلت بعده
// «بوصلة مدار» نفسها بقرار المالك. لا نستنتج حالةً من نصّ المذكرة الخام ولا
// نرسل شيئاً خارج الجهاز؛ ما يبقى هنا خلاصةٌ وصفيّةٌ لليوم لا توصية.

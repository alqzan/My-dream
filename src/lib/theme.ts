...
const PALETTE_TOKENS: Record<AccentPalette, { light: ThemeTokenSet; dark: ThemeTokenSet }> = {
  madar: {
    light: {
      ...
      positive: "#87551d", positiveSoft: "rgba(185, 134, 47, .13)", clay: "#c15a34", blue: "#3f6f8f",
    },
    dark: {
      ...
      positive: "#d3a24d", positiveSoft: "rgba(223, 174, 94, .15)", clay: "#dd7d55", blue: "#7ea9c7",
    },
  },
  emerald: {
    light: {
      ...
      positive: "#267956", positiveSoft: "rgba(44, 137, 101, .14)", clay: "#b65d43", blue: "#39758c",
    },
    dark: {
      ...
      positive: "#63c493", positiveSoft: "rgba(99, 196, 147, .16)", clay: "#e08b6d", blue: "#82bed0",
    },
  },
  ocean: {
    light: {
      ...
      positive: "#2f7187", positiveSoft: "rgba(50, 123, 145, .14)", clay: "#bd654f", blue: "#2f7187",
    },
    dark: {
      ...
      positive: "#67c1d0", positiveSoft: "rgba(103, 193, 208, .16)", clay: "#e58c72", blue: "#7fc5db",
    },
  },
  rose: {
    light: {
      ...
      positive: "#a84f62", positiveSoft: "rgba(173, 88, 105, .14)", clay: "#b45245", blue: "#527b98",
    },
    dark: {
      ...
      positive: "#e18a9d", positiveSoft: "rgba(225, 138, 157, .16)", clay: "#ef9886", blue: "#91bed2",
    },
  },
  indigo: {
    light: {
      ...
      positive: "#6754a0", positiveSoft: "rgba(113, 96, 173, .14)", clay: "#b85f53", blue: "#5a77a7",
    },
    dark: {
      ...
      positive: "#ad9be4", positiveSoft: "rgba(173, 155, 228, .16)", clay: "#e89683", blue: "#9bb9e1",
    },
  },
};

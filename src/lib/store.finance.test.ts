...
import { today, cashOut, dailyShare, computeDailyBudgetStatus, reserveBalance } from "./utils";
...
// الزرّ المعاكس للـsweep: ما رُحّل لصندوق الفوائض يعود لرصيد اليومية. الضمانة
// المهمّة أن الرصيد يرتفع بمقدار المسحوب بالضبط — لا بمخصّص يومٍ إضافيّ ولا
// أقلّ بما صُرف اليوم — وأنّ الصندوق ينقص المقدار نفسه بلا معاملة صرفٍ وهمية.

...
// تماماً كالمطبوع.
//
// **ترخيصُ المصدر: تعارضٌ لم يُحسم.** الحزمة المنشورة تحمل بيانَين متعارضَين:
// `package.json` يعلن ISC، و`LICENSE.md` **داخل الحزمة نفسها** يقول إنّ الكود
// والأصول تحت رخصة «وقف» العامّة 2.0 — وهي رخصةٌ ذاتُ شروط لا رخصةٌ متساهلة.
// لا تكتب هنا (ولا في أيّ مكان) أنّ الترخيص ISC كأنّه محسوم. التفصيل الكامل
// ونصوصُ التراخيص والإسنادُ الواجب في `THIRD-PARTY-NOTICES.md` بجذر المستودع،
// وهو المرجع الوحيد لهذه المسألة.
//
